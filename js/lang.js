const langArr = {
  ...
  header: {
    ...
    rent: {
      en: "Why Rent Lasers",
      de: "Warum Laser Mieten",
      sk: "Prečo si prenajať lasery",
    },
    advantages: {
      en: "Advantages",
      de: "Vorteile",
  ...
  rent: {
    ...
    right__laser_2_charact_1: {
      ...
      sk: "12 bar 1200 W príkon rukoväte",
    },
    right__laser_2_charact_2: {
      en: "Soprano Ice Titanium, spot size 12 * 20 mm or 12 * 35 mm",
      de: "Soprano Ice Titanium, Spotgröße 12 * 20 mm oder 12 * 35 mm",
      sk: "Sopran Ice Titanium, veľkosť bodu 12 * 20 mm alebo 12 * 35 mm",
    },
    ...
    right_a: {
      ...
      sk: "Požičajte si vybavenie TERAZ!",
    },
  ...
  advantage: {
    ...
    header2: {
      en: "Perform procedures with D-Laz devices right now!",
      de: "Führen Sie jetzt Eingriffe mit D-Laz-Geräten durch!",
      sk: "Vykonajte procedúry so zariadeniami D-Laz práve teraz!",
    },
    card_1_title: {
      en: "Quick start",
      de: "Schnellstart",
    ...
    card_4_text: {
      en: "We are always ready to promptly resolve any technical issues.",
      de: "Wir sind immer bereit, technische Probleme umgehend zu lösen.",
      sk: "Sme vždy pripravení promptne vyriešiť akékoľvek technické problémy.",
    },
